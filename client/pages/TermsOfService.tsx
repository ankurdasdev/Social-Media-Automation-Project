    ...
    <div className="min-h-screen bg-[#060610] text-foreground">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-12">
        ...
        <div className="prose prose-invert max-w-none space-y-10 text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-black text-white">3. Eligibility</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-black text-white">4. Account Registration</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-black text-white">5. Acceptable Use Policy</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-black text-white">6. Third-Party Platforms</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-black text-white">7. Subscription and Payments</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-black text-white">8. Intellectual Property</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-black text-white">10. Disclaimer of Warranties</h2>
            <p>The Platform is provided "as is" and "as available" without warranties of any kind, either express or implied, including but not limited to warranties of merchantability, fitness for a particular purpose, or non-infringement. We do not warrant that the Platform will be uninterrupted, error-free, or free of viruses.</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-black text-white">11. Termination</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-black text-white">12. Governing Law</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-black text-white">13. Changes to Terms</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-black text-white">14. Contact Us</h2>

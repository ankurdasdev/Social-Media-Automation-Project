...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-[#060610] text-foreground">
      ...
      {/* Navbar */}
      <nav className="sticky top-0 z-50 border-b border-white/5 bg-[#060610]/80 backdrop-blur-xl px-6 py-4 flex items-center justify-between">
    ...
    <div className="prose prose-invert max-w-none space-y-10 text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc pl-6 space-y-1.5">
          <li><strong className="text-white">Account Information:</strong> Name, email address, phone number, gender, and date of birth provided at registration.</li>
          <li><strong className="text-white">Usage Data:</strong> Log data, IP addresses, browser type, pages visited, and time spent on the platform.</li>
          <li><strong className="text-white">Integration Credentials:</strong> OAuth tokens for Google (Gmail/Drive) and session data for WhatsApp and Instagram connections.</li>
          <li><strong className="text-white">Contact Data:</strong> Information you upload or import (e.g., talent contact lists) for use with our outreach tools.</li>
          <li><strong className="text-white">Payment Information:</strong> Billing details processed via our payment providers (Razorpay). We do not store raw card details.</li>
          <li><strong className="text-white">Communications:</strong> Messages, templates, and campaign content you create within the platform.</li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-black text-white">4. Data Sharing and Disclosure</h2>
        <p>We do not sell, trade, or rent your personal information. We may share data with:</p>
        <ul className="list-disc pl-6 space-y-1.5">
          <li><strong className="text-white">Service Providers:</strong> Third-party vendors that assist us in operating the platform (e.g., cloud hosting, email delivery, payment processing).</li>
          <li><strong className="text-white">Third-Party Platforms:</strong> When you authorize integrations with Google, WhatsApp, or Instagram, relevant data is transmitted to those platforms under their own privacy policies.</li>
          <li><strong className="text-white">Legal Requirements:</strong> We may disclose your data if required by law, court order, or governmental authority.</li>
          <li><strong className="text-white">Business Transfers:</strong> In the event of a merger, acquisition, or sale of assets, your data may be transferred as part of the transaction.</li>
        </ul>
      </section>

      <section className="space-y-3">
        <h2 className="text-xl font-black text-white">5. Data Retention</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-black text-white">6. Cookies and Tracking</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-black text-white">7. Data Security</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-black text-white">8. Your Rights</h2>
        ...
        <ul className="list-disc pl-6 space-y-1.5">
          ...
          <li><strong className="text-white">Objection:</strong> Object to or restrict certain types of processing.</li>
        </ul>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-black text-white">9. Children's Privacy</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-black text-white">10. Third-Party Services</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-black text-white">11. International Data Transfers</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-black text-white">12. Changes to This Policy</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-black text-white">13. Contact Us</h2>
